...
export const ml: LocaleTree = {
  ...
  "hero": {
    ...
    "pragmaticLine2": "ദിവസേന, ആഴ്ചതോറും, മാസംതോറും {{percent}}% വരെ ക്യാഷ്ബാക്ക്",
    "sportsbookLine1": "ബെറ്റ് ഓൺ",
    "sportsbookAccent": "സ്പോർട്സ് ബുക്ക്",
    "liveCasinoLine1": "Play",
    "liveCasinoAccent": "Live Casino",
    "liveCasinoLine2": "ആഴ്ചതോറും, മാസംതോറും {{percent}}% വരെ ക്യാഷ്ബാക്ക്",
