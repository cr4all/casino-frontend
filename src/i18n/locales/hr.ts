...
export const hr: LocaleTree = {
  ...
  "nav": {
    ...
    "casino": "CASINO",
    "sports": "SPORT",
    "platformSection": "Odjeljak platforme",
    "prematch": "PREMATCH",
    "prematchLabel": "Klađenje prije utakmice",
    "inLive": "UŽIVO",
    "inLiveLabel": "Klađenje uživo",
  ...
  "sports": {
    ...
    "error": "Nije moguće učitati sportsku kladionicu.",
    "loginRequired": "Prijavite se za pristup sportskom klađenju."
  },
  "liveChat": {
    "title": "Live Chat",
  ...
  "hero": {
    "welcomeTagline": "Najveća sportska kladionica i online kasino na svijetu",
    "playNow": "Play Now",
    "betNow": "Kladite se sada",
    "registerPromo": "Register Now",
    "pragmaticLine1": "Play",
    "pragmaticAccent": "Pragmatic Slots",
    "pragmaticLine2": "Dnevni, tjedni, mjesečni cashback do {{percent}}%",
    "sportsbookLine1": "Kladite se na",
    "sportsbookAccent": "Sportska knjiga",
    "liveCasinoLine1": "Play",
    "liveCasinoAccent": "Live Casino",
    "liveCasinoLine2": "Tjedni, mjesečni cashback do {{percent}}%",
  ...
  "sportsBetHistory": {
    "title": "Sportske oklade",
    "noBets": "Još nema sportskih oklada. Stavite okladu u kladionicu kako biste vidjeli svoju povijest ovdje.",
    "browseSports": "Otvori kladionicu",
    "roundId": "ID RUNDE:",
  ...
  "affiliate": {
    ...
    "availablePayout": "Dostupno za povlačenje",
    "accruingCommission": "Obračun (tekući mjesec)",
    "payouts": "Isplate",
    "payoutDetails": "Podaci o isplati",
    "payoutHistory": "Povijest isplata",
    "accountWalletId": "Account / Wallet ID",
    "note": "Note",
    "payoutMethod": "Način isplate",
    "requestPayout": "Zatraži isplatu",
    "payoutRequested": "Zahtjev za isplatu je poslan.",
    "payoutRequestFailed": "Slanje zahtjeva za isplatu nije uspjelo.",
    "payoutDetailsSaved": "Podaci o isplati su spremljeni.",
    "payoutDetailsSaveFailed": "Spremanje podataka o isplati nije uspjelo.",
    "savePayoutDetails": "Spremi podatke o isplati",
    "minPayout": "Minimalni iznos za isplatu",
    "periodEnd": "Dostupno putem",
    "noPayouts": "Još nema zahtjeva za isplatu.",
    "cannotRequestReasonDetails": "Prije nego što zatražite isplatu unesite podatke za isplatu.",
    "cannotRequestReasonPending": "Zahtjev za isplatu već je na čekanju.",
    "cannotRequestReasonBalance": "Još nije dostupna provizija za zatvoreni mjesec.",
    "cannotRequestReasonMinimum": "Dostupna je provizija niža od minimalnog iznosa za isplatu.",
    "methodBank": "Direktna bankovna transakcija",
    "methodCrypto": "Kripto",
    "methodEwallet": "E-novčanik",
    "methodOther": "Drugo",
    ...
    "ewalletProvider": "Davatelj usluge",
    "ewalletAccountId": "ID računa",
    "payoutInstructions": "UPUTE ZA PLAĆANJE",
    "notes": "Napomene",
    "rejectionReason": "Razlog odbijanja troškova"
  },
  "affiliateProgram": {
