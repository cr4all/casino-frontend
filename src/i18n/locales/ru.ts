...
export const ru: LocaleTree = {
  ...
  "hero": {
    "welcomeTagline": "Самая большая букмекерская контора и онлайн-казино в мире",
  ...
  "deposit": {
    ...
    "redirectConfirmHint": "Завершите оплату на странице оплаты. Зачисление после подтверждения.",
