...
export const ru: LocaleTree = {
  ...
  "nav": {
    ...
    "affiliateProgramLabel": "Стать партнёром"
  },
  "sports": {
  ...
  "supportTickets": {
    "title": "Поддержка Разговоры",
    "subtitle": "Submit a request and track replies from our support team.",
    "newTicket": "Новый Разговоры",
    "subject": "Тема",
    "category": "Тип",
    "message": "Сообщение",
    "submit": "Отправить Разговоры",
    "createFailed": "Не удалось отправить сообщение. Пожалуйста, попробуйте еще раз.",
    "empty": "Разговоров пока нет.",
    "backToList": "← Назад к Разговоры",
    "notFound": "Разговоры не найден.",
    "closedHint": "Этот тикет закрыто. Open a new ticket if you need further help.",
    "replyPlaceholder": "Введите ответ...",
    "sendReply": "Отправить ответ",
    "replyFailed": "Не удалось отправить сообщение. Пожалуйста, попробуйте еще раз.",
    "attach": "Attach",
    "attachedFile": "Attached file",
    "loadOlder": "Load older messages",
  ...
  "hero": {
    "welcomeTagline": "Самая большая в мире букмекерская контора и онлайн-казино",
    "playNow": "Play Now",
    "betNow": "Bet Now",
    "registerPromo": "Register Now",
    "pragmaticLine1": "Play",
    "pragmaticAccent": "Pragmatic Slots",
    "pragmaticLine2": "Ежедневный, еженедельный, ежемесячный кэшбэк до {{percent}}%",
    "sportsbookLine1": "Bet on",
    "sportsbookAccent": "Sports book",
    "liveCasinoLine1": "Play",
    "liveCasinoAccent": "Live Casino",
    "liveCasinoLine2": "Еженедельный, ежемесячный кэшбэк до {{percent}}%",
  ...
  "auth": {
    ...
    "affiliateRegisterTitle": "Стать партнёром",
    "affiliateReferralCode": "Реферальный код",
    "affiliateReferralCodeHint": "Только буквы, цифры, дефисы и подчёркивания. Отображается в вашей реферальной ссылке.",
    "affiliateReferralCodeInvalid": "Используйте 1–50 символов: буквы, цифры, дефисы или подчёркивания.",
    "affiliateRegisterError": "Регистрация партнёра не удалась. Проверьте введённые данные.",
    "hasAffiliateAccount": "Уже партнёр?"
  },
  "profile": {
    "title": "My Profile",
    "email": "Email",
  ...
  "risk": {
    ...
    "challengeFailed": "Проверка не пройдена. Попробуйте снова."
  },
  "deposit": {
    "title": "Deposit",
    "bonusesLink": "Bonuses",
    ...
    "backToMethods": "← Back",
    "backToKinds": "← Назад к методам",
    "backToOptions": "← Back",
    "stepMethod": "Способ оплаты",
    "stepOption": "Выбор опции",
    "stepAmount": "Amount",
    "selectPaymentKind": "Выберите способ пополнения",
  ...
  "wallet": {
    ...
    "withdrawableBonus": "Доступный бонус",
    "bonusLockedHint": "Бонусные средства заблокированы до выполнения условий отыгрыша.",
    "showBreakdown": "Показать детализацию баланса",
    "balanceBreakdown": "Детализация баланса",
