...
export const gu: LocaleTree = {
  ...
  "nav": {
    ...
    "casino": "CASINO",
    "sports": "રમતગમત",
    "platformSection": "પ્લેટફોર્મ વિભાગ",
    "prematch": "PREMATCH",
    "prematchLabel": "મેચ પૂર્વેની શરત",
    "inLive": "LIVE માં",
    "inLiveLabel": "જીવંત સટ્ટાબાજી",
    "sportsHistory": "HISTORY",
    "sportsHistoryLabel": "મારી સ્પોર્ટ્સ બેટ્સ",
    "casinoHistory": "HISTORY",
    "casinoHistoryLabel": "Game bet history",
    "favorites": "મનપસંદ",
    "favoritesLabel": "સાચવેલી રમતો"
  },
  "sports": {
    "launching": "સ્પોર્ટ્સબુક લોડ થઈ રહી છે...",
    "error": "સ્પોર્ટ્સબુક લોડ કરવામાં અસમર્થ.",
    "loginRequired": "સ્પોર્ટ્સ સટ્ટાબાજીને ઍક્સેસ કરવા માટે સાઇન ઇન કરો."
  },
  "liveChat": {
    "title": "Live Chat",
  ...
  "hero": {
    ...
    "pragmaticLine2": "દૈનિક, સાપ્તાહિક, માસિક {{percent}}% સુધી કેશબેક",
    "sportsbookLine1": "પર વિશ્વાસ મૂકીએ",
    "sportsbookAccent": "રમતગમતનું પુસ્તક",
    "liveCasinoLine1": "Play",
    "liveCasinoAccent": "Live Casino",
    "liveCasinoLine2": "સાપ્તાહિક, માસિક {{percent}}% સુધી કેશબેક",
  ...
  "sportsBetHistory": {
    "title": "સ્પોર્ટ્સ બેટ્સ",
    "noBets": "હજી સુધી કોઈ સ્પોર્ટ્સ બેટ્સ નથી. તમારો ઇતિહાસ અહીં જોવા માટે સ્પોર્ટ્સબુકમાં બીઇટી મૂકો.",
    "browseSports": "સ્પોર્ટ્સબુક પર જાઓ",
    "roundId": "રાઉન્ડ ID",
    "paymentId": "ચુકવણી ID",
    "event": "ઇવેન્ટ",
    "sport": "રમત",
  ...
  "affiliate": {
    ...
    "availablePayout": "ઉપાડવા માટે ઉપલબ્ધ",
    "accruingCommission": "ઉપાર્જિત (વર્તમાન મહિનો)",
    "payouts": "ચૂકવણી",
    "payoutDetails": "ચૂકવણીની વિગતો",
    "payoutHistory": "ચુકવણીનો ઇતિહાસ",
    "accountWalletId": "Account / Wallet ID",
    "note": "Note",
    "payoutMethod": "ચુકવણીની પદ્ધતિ",
    "requestPayout": "ચૂકવણીની વિનંતી કરો",
    "payoutRequested": "ચુકવણીની વિનંતી સબમિટ કરવામાં આવી.",
    "payoutRequestFailed": "ચુકવણીની વિનંતી કરવામાં નિષ્ફળ.",
    "payoutDetailsSaved": "ચુકવણીની વિગતો સાચવવામાં આવી છે.",
    "payoutDetailsSaveFailed": "ચુકવણીની વિગતો સાચવવામાં નિષ્ફળ.",
    "savePayoutDetails": "ચુકવણીની વિગતો સાચવો",
    "minPayout": "ન્યૂનતમ ચુકવણી",
    "periodEnd": "દ્વારા ઉપલબ્ધ છે",
    "noPayouts": "હજી સુધી કોઈ ચૂકવણીની વિનંતીઓ નથી.",
    "cannotRequestReasonDetails": "ચુકવણીની વિનંતી કરતા પહેલા ચુકવણીની વિગતો ઉમેરો.",
    "cannotRequestReasonPending": "ચુકવણીની વિનંતી પહેલાથી જ બાકી છે.",
    "cannotRequestReasonBalance": "હજી સુધી કોઈ બંધ-મહિનો કમિશન ઉપલબ્ધ નથી.",
    "cannotRequestReasonMinimum": "ઉપલબ્ધ કમિશન ન્યૂનતમ ચૂકવણીની રકમથી નીચે છે.",
    "methodBank": "બેન્ક ટ્રાન્સફર",
    "methodCrypto": "ક્રાય્પ્ટોComment",
    "methodEwallet": "ઈ-વોલેટ",
    "methodOther": "અન્ય",
    "accountName": "ખાતા નામ",
    "bankName": "બેંકનું નામ",
    "accountNumber": "એકાઉન્ટ નંબર",
    "swiftBic": "સ્વિફ્ટ/BIC",
    "iban": "IBAN",
    "country": "દેશ",
    "walletAddress": "વૉલેટનું સરનામું",
    "network": "નેટવર્ક",
    "cryptoCurrency": "કરન્સી",
    "ewalletProvider": "પ્રદાતા",
    "ewalletAccountId": "ખાતા ID:",
    "payoutInstructions": "ચુકવણીની સૂચનાઓ",
    "notes": "નોંધો",
