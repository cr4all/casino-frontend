...
export const deBe: LocaleTree = {
  ...
  "affiliateProgram": {
    ...
    "revshareDesc": "Verdiene einen laufenden Prozentsatz des Netto-Glücksspielumsatzes (NGR) von empfohlenen Spielern. RevShare wird anhand des Cash-Gameplays GGR abzüglich der Bonuskosten berechnet — abgestimmt auf den tatsächlichen Spielerwert.",
    "revsharePoint1": "Lebenslange Umsatzbeteiligung an qualifizierten Spieleraktivitäten",
    ...
    "cpaTitle": "CPA (Anschaffungskosten)",
    "cpaDesc": "Erhalten Sie eine feste einmalige Zahlung, wenn ein empfohlener Spieler eine qualifizierte erste Einzahlung abschließt. Perfekt, wenn Sie vorhersehbare Vorab-Rücksendungen benötigen.",
    "cpaPoint1": "Einzelauszahlung bei der ersten qualifizierenden Einzahlung ausgelöst",
    "cpaPoint2": "Klare, im Voraus vereinbarte Qualifizierungsregeln",
    "cpaPoint3": "Ideal für bezahlte Medien und großvolumige Akquisitionstrichter",
    "hybridTitle": "Hybrid (CPA + RevShare)",
    "hybridDesc": "Kombiniere ein CPA im Voraus mit fortlaufendem RevShare auf demselben Spieler. Saldieren Sie den sofortigen Cashflow mit den Long-Tail-Einkünften aktiver Spieler.",
