...
export const el: LocaleTree = {
  ...
  "affiliate": {
    ...
    "availablePayout": "Διαθέσιμο για ανάληψη",
    "accruingCommission": "Συγκεντρωτικά (Τρέχων μήνας)",
    "commissions": "Προμήθειες",
    "commissionHistory": "Ιστορικό προμηθειών",
    "payouts": "Χρηματική επιβράβευση",
    "payoutDetails": "Λεπτομέρειες χρηματικής επιβράβευσης",
    "payoutHistory": "Ιστορικό πληρωμών οικοδεσπότη",
    "accountWalletId": "Αναγνωριστικό λογαριασμού / πορτοφολιού",
    "note": "Σημείωση",
    "payoutMethod": "Μέθοδος επιβράβευσης",
    "requestPayout": "Αίτημα αποπληρωμής",
    "payoutRequested": "Το αίτημα πληρωμής οικοδεσπότη υποβλήθηκε.",
    "payoutRequestFailed": "Απέτυχε το αίτημα πληρωμής οικοδεσπότη.",
    "payoutDetailsSaved": "Τα στοιχεία πληρωμής οικοδεσπότη αποθηκεύτηκαν.",
    "payoutDetailsSaveFailed": "Η αποθήκευση των στοιχείων πληρωμής οικοδεσπότη απέτυχε.",
    "savePayoutDetails": "Λεπτομέρειες χρηματικής επιβράβευσης",
    "minPayout": "Ελάχιστη Πληρωμή",
    "periodEnd": "Διαθέσιμο μέσω",
    "noPayouts": "Δεν υπάρχουν ακόμη αιτήματα πληρωμής οικοδεσπότη.",
    "cannotRequestReasonDetails": "Προσθέστε στοιχεία πληρωμής οικοδεσπότη πριν στείλετε αίτημα για πληρωμή οικοδεσπότη.",
    "cannotRequestReasonPending": "Ένα αίτημα πληρωμής οικοδεσπότη εκκρεμεί ήδη.",
    "cannotRequestReasonBalance": "Δεν υπάρχει ακόμα προμήθεια κλειστού μήνα.",
    "cannotRequestReasonMinimum": "Η διαθέσιμη προμήθεια είναι κάτω από το ελάχιστο ποσό πληρωμής οικοδεσπότη.",
    "methodBank": "Τραπεζικό έμβασμα",
    "methodCrypto": "Κρυπτο",
    "methodEwallet": "Ηλεκτρονικό πορτοφόλι",
    "methodOther": "Άλλα",
    ...
    "network": "Δίκτυο",
    "cryptoCurrency": "Νόμισμα",
    "ewalletProvider": "Παροχέας",
    "ewalletAccountId": "ID λογαριασμού",
    "payoutInstructions": "Οδηγίες Πληρωμής",
    "notes": "Σημειώσεις",
