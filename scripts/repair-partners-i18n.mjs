...
const MANUAL_FOOTER = {
  ...
  ne: { partners: 'पार्टनरहरू', affiliateProgram: 'Affiliate Program', becomePartner: 'पार्टनर बन्नुहोस्' },
  ...
  my: { partners: 'မိတ်ဖက်များ', affiliateProgram: 'Affiliate Program', becomePartner: 'မိတ်ဖက်ဖြစ်လာရန်' },
